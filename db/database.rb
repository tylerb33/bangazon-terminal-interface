...
begin
    ...
    db = SQLite3::Database.open( "database_sprint2.sqlite" )
	...
	db.execute "CREATE TABLE Payment_Types(Payment_Type_Id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, Account_Number TEXT, Title TEXT)"
