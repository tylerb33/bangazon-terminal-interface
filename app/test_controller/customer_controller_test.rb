...
class CustomerTest < Minitest::Test
	...
	def test_last_name_correct_class_type
		assert_kind_of String, @customer_controller.set_customer_last_name("pants")
	end

	def test_street_address_correct_class_type
		assert_kind_of String, @customer_controller.set_customer_street_address("poopy")
	end
	
	def test_city_correct_class_type
		assert_kind_of String, @customer_controller.set_customer_city("poopy")
	end

	def test_state_correct_class_type
		assert_kind_of String, @customer_controller.set_customer_state("poopy")
	end

	def test_postal_code_correct_class_type
		assert_kind_of String, @customer_controller.set_customer_postal_code("poopy")
	end

	def test_phone_number_correct_class_type
		assert_kind_of String, @customer_controller.set_customer_phone_number("poopy")
	end

	# def test_last_name_sets_correct_value
	# 	assert @customer_controller[info_last_name] === "Johnson", @customer_test.set_customer_last_name("Johnson")
	# end
end
